...
fc_result <- forecast_epidemic_curve_log(epidemic_curve, cutoff_date = as.Date("2020-02-25"), horizon = 7)

forecast_chart <- create_forecast_chart(fc_result, title = "ARIMA predicted curve vs. actual outbreak curve")
